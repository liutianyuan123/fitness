...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune donnée dans la table",sInfo:"De _START_ à _END_ sur _TOTAL_ lignes",sInfoEmpty:"De 0 à 0 sur 0 lignes",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrement trouvé"},
