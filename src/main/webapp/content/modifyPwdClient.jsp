...
<html lang="fr">
    <head>
        ...
        <script type="text/JavaScript" src="../js/ajaxModifyPwd.js"></script>
    </head>
                        ...
                        <div class="col-lg-6" >
                            <div class="card">
                                <div class="card-title">
                                    <h4>Modification votre mot de passe</h4>
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <div id="errorPwd"></div>
                                        <button type="button" class="btn btn-danger btn-rounded m-b-10 m-l-5" onclick="modifyPwdClient()">Modifier</button>
