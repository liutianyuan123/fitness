                    ...
                    <div class='row'>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="card-body">
                                    <form action="modifyPersoConfirm.jsp" method="get">
                                       ...
                                       <%  String ids=(String)session.getAttribute("id");
                                         ...
                                         ArrayList<Profil> p= new dbClient().getProfilUser(id);
                                     

                                         %>
                                                    <div class="form-group">
                                                        <label class="control-label">Nom</label>
                                                        <input type="text" id="nom" class="form-control" name="nom" value="<%=u.getNomu()%>" disabled>
                                                    </div>
                                                     <div class="form-group">
                                                        <label class="control-label">Prenom</label>
                                                        <input type="text" id="prenom" class="form-control" name="prenom" value="<%=u.getPrenomu()%>" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   %>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input type="text" id="adress" class="form-control" name="adress" value="<%=u.getAdresseu()%>" disabled>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                        ...
                                        <button type="submit" class="btn btn-warning btn-rounded m-b-10 m-l-5"><i class="fa fa-check"></i>Modifier</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
